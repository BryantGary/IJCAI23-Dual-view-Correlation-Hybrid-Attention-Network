...
net1 = pretrain_CNN_noaug.CNN(Bottleneck,[3,4,23,3])
#net2 = pretrain_CNN_noaug.CNN(Bottleneck,[3,4,23,3])
pretrained_dict1 = resnet101.state_dict()
#pretrained_dict2 = resnet101.state_dict()
model_dict1 = net1.state_dict()
...
net1.load_state_dict(model_dict1)
...
class Model(nn.Module):
    ...
    def forward(self, CC,MLO):
        CC_predict, CC_feature = self.model_a(CC)
        MLO_predict, MLO_feature = self.model_a(MLO)
